...
-- Base de Dados: `cep`
--
CREATE DATABASE IF NOT EXISTS `cep` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cep`;
...
INSERT INTO `pessoas` (`id`, `nome`, `cidade`, `estado`, `email`) VALUES
(0, 'fernando', '4742', '26', 'fe_piz@gmail.com');
